 ...
 * @public
 */
export declare type ContentBlock = TextBlock | FileBlock | VideoBlock | ImageBlock | AudioBlock | VoiceBlock | LocationBlock;
 ...
 *
 * We will add new FileBlock variants in the future, for example a `DocumentBlock` for text documents.
 * This will not be considered a breaking change, so you should not explicitly check for `subtype: undefined` in your code.
 *
 ...
 * ```
 *
 * If the text nodes is not a plain string, it will have a `type` field indicating what kind of node it is, and either a property `text: string` or a property `children: TextNode[]`.
...
/**
 * A FileBlock variant for a voice message attachment, with additional voice-message-specific metadata.
